...
(function() {
  var $, Animal, DISP_ANIMAL, DISP_EMPTY, DISP_PLANT, JUNGLE, WORLD_HEIGHT, WORLD_WIDTH, add_plants, animals, dist_x_by_dir, dist_y_by_dir, draw_world, plants, random_int, skip_day, sum_array, update_world, world;
  ...
  Animal = (function() {
    function Animal(x, y, direction, genes) {
      this.x = x;
      this.y = y;
